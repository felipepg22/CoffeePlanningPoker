...
- Add WebSocket-backed room membership updates so participants see joins, leaves, and reconnects without manual refresh.
...
- `room-collaboration`: Covers creating named planning poker rooms, inviting players, joining rooms with participant names, and synchronizing room membership/presence through WebSocket events.
...
- Introduces a replaceable WebSocket service boundary for room events, membership state, reconnect handling, and room error states.
